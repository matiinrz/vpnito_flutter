...
ThemeData customLightTheme(
  ...
  return ThemeData(
      ...
      floatingActionButtonTheme:
          const FloatingActionButtonThemeData(backgroundColor: Color.fromRGBO(
              255, 0, 0, 1.0)),
      unselectedWidgetColor: Colors.grey,
      brightness: Brightness.light,
      fontFamily: GoogleFonts.montserrat().fontFamily,
      secondaryHeaderColor: const Color.fromRGBO(4, 77, 128, 1.0),
      cardColor: const Color.fromRGBO(239, 242, 248, 1),
      iconTheme: const IconThemeData(color: Colors.black),
      tabBarTheme: TabBarTheme(
        unselectedLabelColor: Colors.black.withOpacity(.5),
      ),
      appBarTheme: const AppBarTheme(elevation: 0, color: Colors.white, iconTheme: IconThemeData(color: Colors.black)),
      ...
      textSelectionTheme: const TextSelectionThemeData(cursorColor: Color.fromRGBO(
          255, 0, 0, 1.0)));
}
